...
namespace GreatExpectations
{
    ...
    {
        public static Assertion[] Assert(CloudStorageAccount storageAccount, string containerName, string dataSetPrefix, int minFileExpectation = 1, int maxFileExpectation = 1, string customVariableFormat = "")
        {
            ...
            var expectations = expectationGenerator.GenerateExpectations(lastExecutionEpoch, DateTime.Now, dataSetPrefix, minFileExpectation, maxFileExpectation, customVariableFormat);
